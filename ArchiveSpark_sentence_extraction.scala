...
val warcPath = "/user/cs4984cs5984f18_team7/7_Shooting_Las_Vegas_2017/"
val cdxPath = "/user/cs4984cs5984f18_team7/7_Shooting_Las_Vegas_2017/Shooting_Las_Vegas_2017.cdx"
...
cleaned_df.repartition(1).write.mode("overwrite").format("json").save("/user/cs4984cs5984f18_team7/7_Shooting_Las_Vegas_2017/sentences") // export data to your local path
